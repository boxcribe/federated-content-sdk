...
public class DiningOfferRequestSchema {
  ...
  public DiningOfferRequestSchema locationLatitude(Float locationLatitude) {
  ...
  **/
  ...
  public DiningOfferRequestSchema locationLongitude(Float locationLongitude) {
  ...
  **/
  ...
  public DiningOfferRequestSchema locationRadius(Float locationRadius) {
  ...
  **/
  ...
  public DiningOfferRequestSchema date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @Schema(description = "Date for the dining search.")
  ...
  public DiningOfferRequestSchema filterByKeyword(String filterByKeyword) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByPriceMin(BigDecimal filterByPriceMin) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByPriceMax(BigDecimal filterByPriceMax) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByDistanceMin(BigDecimal filterByDistanceMin) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByDistanceMax(BigDecimal filterByDistanceMax) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByRatingMin(BigDecimal filterByRatingMin) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterByRatingMax(BigDecimal filterByRatingMax) {
  ...
  **/
  ...
  public DiningOfferRequestSchema filterBySubcategories(List<String> filterBySubcategories) {
    this.filterBySubcategories = filterBySubcategories;
    return this;
  }

  public DiningOfferRequestSchema addFilterBySubcategoriesItem(String filterBySubcategoriesItem) {
  ...
  **/
  ...
  public DiningOfferRequestSchema sortBy(String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  **/
  ...
  public DiningOfferRequestSchema sortOrder(String sortOrder) {
  ...
  **/
  ...
  public DiningOfferRequestSchema page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public DiningOfferRequestSchema limit(BigDecimal limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public DiningOfferRequestSchema language(String language) {
  ...
  **/
  ...
  public DiningOfferRequestSchema currency(String currency) {
  ...
  **/
  ...
  public DiningOfferRequestSchema metric(String metric) {
    this.metric = metric;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DiningOfferRequestSchema diningOfferRequestSchema = (DiningOfferRequestSchema) o;
    return Objects.equals(this.locationLatitude, diningOfferRequestSchema.locationLatitude) &&
        Objects.equals(this.locationLongitude, diningOfferRequestSchema.locationLongitude) &&
        Objects.equals(this.locationRadius, diningOfferRequestSchema.locationRadius) &&
        Objects.equals(this.date, diningOfferRequestSchema.date) &&
        Objects.equals(this.filterByKeyword, diningOfferRequestSchema.filterByKeyword) &&
        Objects.equals(this.filterByPriceMin, diningOfferRequestSchema.filterByPriceMin) &&
        Objects.equals(this.filterByPriceMax, diningOfferRequestSchema.filterByPriceMax) &&
        Objects.equals(this.filterByDistanceMin, diningOfferRequestSchema.filterByDistanceMin) &&
        Objects.equals(this.filterByDistanceMax, diningOfferRequestSchema.filterByDistanceMax) &&
        Objects.equals(this.filterByRatingMin, diningOfferRequestSchema.filterByRatingMin) &&
        Objects.equals(this.filterByRatingMax, diningOfferRequestSchema.filterByRatingMax) &&
        Objects.equals(this.filterBySubcategories, diningOfferRequestSchema.filterBySubcategories) &&
        Objects.equals(this.sortBy, diningOfferRequestSchema.sortBy) &&
        Objects.equals(this.sortOrder, diningOfferRequestSchema.sortOrder) &&
        Objects.equals(this.page, diningOfferRequestSchema.page) &&
        Objects.equals(this.limit, diningOfferRequestSchema.limit) &&
        Objects.equals(this.language, diningOfferRequestSchema.language) &&
        Objects.equals(this.currency, diningOfferRequestSchema.currency) &&
        Objects.equals(this.metric, diningOfferRequestSchema.metric);
  }

  @Override
  public int hashCode() {
    return Objects.hash(locationLatitude, locationLongitude, locationRadius, date, filterByKeyword, filterByPriceMin, filterByPriceMax, filterByDistanceMin, filterByDistanceMax, filterByRatingMin, filterByRatingMax, filterBySubcategories, sortBy, sortOrder, page, limit, language, currency, metric);
  }

...
module SwaggerClient
  class FlightGetBookingDetailsResponseSchema
    ...
    attr_accessor :booking_cancellation_policies
    ...
    def self.openapi_types
      {
        ...
        :'booking_cancellation_policies' => :'Object',
        :'customer' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::FlightGetBookingDetailsResponseSchema` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::FlightGetBookingDetailsResponseSchema`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'booking_cancellation_policies')
        self.booking_cancellation_policies = attributes[:'booking_cancellation_policies']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          booking_cancellation_policies == o.booking_cancellation_policies &&
          customer == o.customer &&
    ...
    def hash
      [company_id, tenant_id, category_id, supplier_id, booking_id, supplier_booking_id, supplier_booking_reference, customer_reference, booking_reference, payment_reference, booking_status, booking_tax, booking_price, booking_currency, booking_cancellation_policies, customer, offer_request, offer, passengers, success, error_message].hash
    end

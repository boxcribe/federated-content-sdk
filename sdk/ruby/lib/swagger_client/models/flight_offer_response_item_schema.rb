...
module SwaggerClient
  class FlightOfferResponseItemSchema
    ...
    attr_accessor :offer_airline_name

    # Code of the airline providing the offer.
    attr_accessor :offer_airline_code

    # Logo URL of the airline.
    attr_accessor :offer_airline_logo
    ...
    def self.openapi_types
      {
        ...
        :'offer_airline_name' => :'Object',
        :'offer_airline_code' => :'Object',
        :'offer_airline_logo' => :'Object',
        :'legs' => :'Object',
        :'passengers' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::FlightOfferResponseItemSchema` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::FlightOfferResponseItemSchema`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'offer_cancelation_policies')
        if (value = attributes[:'offer_cancelation_policies']).is_a?(Hash)
          self.offer_cancelation_policies = value
        end
      end

      if attributes.key?(:'offer_airline_name')
        self.offer_airline_name = attributes[:'offer_airline_name']
      end

      if attributes.key?(:'offer_airline_code')
        self.offer_airline_code = attributes[:'offer_airline_code']
      end

      if attributes.key?(:'offer_airline_logo')
        self.offer_airline_logo = attributes[:'offer_airline_logo']
      end
      ...
      if attributes.key?(:'private_fare_codes')
        if (value = attributes[:'private_fare_codes']).is_a?(Array)
          self.private_fare_codes = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offer_airline_name == o.offer_airline_name &&
          offer_airline_code == o.offer_airline_code &&
          offer_airline_logo == o.offer_airline_logo &&
          legs == o.legs &&
    ...
    def hash
      [offer_id, supplier_offer_id, offer_index, offer_price, offer_currency, offer_cancelation_policies, offer_airline_name, offer_airline_code, offer_airline_logo, legs, passengers, private_fare_codes].hash
    end

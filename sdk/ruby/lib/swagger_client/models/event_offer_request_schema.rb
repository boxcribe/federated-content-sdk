...
module SwaggerClient
  class EventOfferRequestSchema
    ...
    attr_accessor :filter_by_performers
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EventOfferRequestSchema` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EventOfferRequestSchema`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'filter_by_performers')
        if (value = attributes[:'filter_by_performers']).is_a?(Array)
          self.filter_by_performers = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filter_by_performers == o.filter_by_performers &&
    ...
    def hash
      [location_latitude, location_longitude, location_radius, start_date, end_date, filter_by_keyword, filter_by_price_min, filter_by_price_max, filter_by_distance_min, filter_by_distance_max, filter_by_rating_min, filter_by_rating_max, filter_by_performers, filter_by_subcategories, sort_by, sort_order, page, limit, language, currency, metric].hash
    end

...
# Unit tests for SwaggerClient::SchemasIdBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SchemasIdBody' do
  before do
    # run before each test
    @instance = SwaggerClient::SchemasIdBody.new
  end
  ...
  describe 'test an instance of SchemasIdBody' do
    it 'should create an instance of SchemasIdBody' do
      expect(@instance).to be_instance_of(SwaggerClient::SchemasIdBody)
    end
  end

...
namespace IO.Swagger.Model {
  ...
  public class Mapping {
    ...
    /// </summary>
    /// <value>Equivalent mapping path/formula for field_id into the integration_id response item schema</value>
    [DataMember(Name="mapping", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "mapping")]
    public Object _Mapping { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  _Mapping: ").Append(_Mapping).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }

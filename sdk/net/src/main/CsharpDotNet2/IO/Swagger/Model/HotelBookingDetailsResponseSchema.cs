...
namespace IO.Swagger.Model {
  ...
  public class HotelBookingDetailsResponseSchema {
    ...
    public HotelBookingCustomerSchema Customer { get; set; }
    ...
    public HotelOfferRequestSchema OfferRequest { get; set; }
    ...
    public HotelOfferResponseItemSchema Offer { get; set; }
    ...
    public HotelRoomSchema Room { get; set; }

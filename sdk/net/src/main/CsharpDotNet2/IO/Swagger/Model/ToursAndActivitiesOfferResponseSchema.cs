...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ToursAndActivitiesOfferResponseSchema {
    /// <summary>
    ...
    /// </summary>
    /// <value>Array of TourOfferResponseItemSchema detailing individual car offers.</value>
    [DataMember(Name="offers", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "offers")]
    public List<ToursAndActivitiesOfferResponseItemSchema> Offers { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ToursAndActivitiesOfferResponseSchema {\n");

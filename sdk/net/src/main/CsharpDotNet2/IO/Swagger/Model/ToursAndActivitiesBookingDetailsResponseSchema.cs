...
namespace IO.Swagger.Model {
  ...
  public class ToursAndActivitiesBookingDetailsResponseSchema {
    ...
    public ToursAndActivitiesBookingCustomerSchema Customer { get; set; }
    ...
    public ToursAndActivitiesOfferRequestSchema OfferRequest { get; set; }
    ...
    public ToursAndActivitiesOfferResponseItemSchema Offer { get; set; }
    ...
    public ToursAndActivitiesVariantSchema Variant { get; set; }

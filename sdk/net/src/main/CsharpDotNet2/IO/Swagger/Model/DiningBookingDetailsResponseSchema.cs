...
namespace IO.Swagger.Model {
  ...
  public class DiningBookingDetailsResponseSchema {
    ...
    public DiningBookingCustomerSchema Customer { get; set; }
    ...
    public DiningOfferRequestSchema OfferRequest { get; set; }
    ...
    public DiningOfferResponseItemSchema Offer { get; set; }
    ...
    public DiningAvailabilitySchema Availability { get; set; }

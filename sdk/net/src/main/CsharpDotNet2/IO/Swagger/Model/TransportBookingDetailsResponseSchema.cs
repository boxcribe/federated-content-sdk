...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class TransportBookingDetailsResponseSchema {
    /// <summary>
    ...
    public TransportBookingCustomerSchema Customer { get; set; }
    ...
    public TransportOfferRequestSchema OfferRequest { get; set; }
    ...
    public TransportOfferResponseItemSchema Offer { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class TransportBookingDetailsResponseSchema {\n");

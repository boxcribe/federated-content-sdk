...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class CarCancelBookingResponseSchema {
    /// <summary>
    ...
    public CarBookingCustomerSchema Customer { get; set; }
    ...
    public CarOfferRequestSchema OfferRequest { get; set; }
    ...
    public CarOfferResponseItemSchema Offer { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CarCancelBookingResponseSchema {\n");

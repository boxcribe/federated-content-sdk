...
type DiningBookingDetailsResponseSchema struct {
	...
	Customer *DiningBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *DiningOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *DiningOfferResponseItemSchema `json:"offer,omitempty"`
	Availability *DiningAvailabilitySchema `json:"availability,omitempty"`

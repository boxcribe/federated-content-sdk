...
type ToursAndActivitiesBookingDetailsResponseSchema struct {
	...
	Customer *ToursAndActivitiesBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *ToursAndActivitiesOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *ToursAndActivitiesOfferResponseItemSchema `json:"offer,omitempty"`
	Variant *ToursAndActivitiesVariantSchema `json:"variant,omitempty"`

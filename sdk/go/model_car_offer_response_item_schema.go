...
type CarOfferResponseItemSchema struct {
	...
	OfferCancelationPolicies *interface{} `json:"offer_cancelation_policies,omitempty"`
	...
	CarDistance int32 `json:"car_distance,omitempty"`

...
type TransportBookingDetailsResponseSchema struct {
	...
	Customer *TransportBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *TransportOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *TransportOfferResponseItemSchema `json:"offer,omitempty"`

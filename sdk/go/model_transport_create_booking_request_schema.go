...
type TransportCreateBookingRequestSchema struct {
	// Unique identifier for the offer.
	OfferId string `json:"offer_id,omitempty"`
	Customer *TransportCreateBookingCustomerSchema `json:"customer,omitempty"`
	Payment *TransportCreateBookingPaymentSchema `json:"payment,omitempty"`

...
type DiningCreateBookingRequestSchema struct {
	// Unique identifier for the offer.
	OfferId string `json:"offer_id,omitempty"`
	// Unique identifier for the availability.
	AvailabilityId string `json:"availability_id,omitempty"`
	Customer *DiningCreateBookingCustomerSchema `json:"customer,omitempty"`
	Payment *DiningCreateBookingPaymentSchema `json:"payment,omitempty"`

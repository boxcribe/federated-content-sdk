...
type CarBookingDetailsResponseSchema struct {
	...
	Customer *CarBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *CarOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *CarOfferResponseItemSchema `json:"offer,omitempty"`

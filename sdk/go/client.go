...
// APIClient manages communication with the Federated Content API API v1.0.0
...
type APIClient struct {
	...
	ToursAndActivitiesApi *ToursAndActivitiesApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ToursAndActivitiesApi = (*ToursAndActivitiesApiService)(&c.common)

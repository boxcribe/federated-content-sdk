...
type TransportGetOfferAvailabilityResponse struct {
	...
	TransportReviews []interface{} `json:"transport_reviews,omitempty"`
	...
	BookingQuestions []interface{} `json:"booking_questions,omitempty"`
}

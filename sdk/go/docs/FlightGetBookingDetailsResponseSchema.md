...
**BookingTax** | **float32** | Tax applied to the booking. | [optional] [default to null]
**BookingPrice** | **float32** | Total price of the booking. | [optional] [default to null]
...
**Customer** | [***FlightBookingCustomerSchema**](FlightBookingCustomerSchema.md) |  | [optional] [default to null]
**OfferRequest** | [***FlightOfferRequestSchema**](FlightOfferRequestSchema.md) |  | [optional] [default to null]
**Offer** | [***FlightOfferResponseItemSchema**](FlightOfferResponseItemSchema.md) |  | [optional] [default to null]
**Passengers** | [**[]FlightBookingCustomerSchema**](FlightBookingCustomerSchema.md) |  | [optional] [default to null]
**Success** | **bool** | Indicates if the booking was successful. | [optional] [default to null]
**ErrorMessage** | **string** | Provides details on any error that occurred | [optional] [default to null]

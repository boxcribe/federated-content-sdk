...
type EventBookingDetailsResponseSchema struct {
	...
	Customer *EventBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *EventOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *EventOfferResponseItemSchema `json:"offer,omitempty"`
	Ticket *EventTicketSchema `json:"ticket,omitempty"`

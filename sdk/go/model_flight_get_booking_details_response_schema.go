...
type FlightGetBookingDetailsResponseSchema struct {
	...
	BookingTax float32 `json:"booking_tax,omitempty"`
	// Total price of the booking.
	BookingPrice float32 `json:"booking_price,omitempty"`
	...
	BookingCancellationPolicies string `json:"booking_cancellation_policies,omitempty"`
	Customer *FlightBookingCustomerSchema `json:"customer,omitempty"`
	OfferRequest *FlightOfferRequestSchema `json:"offer_request,omitempty"`
	Offer *FlightOfferResponseItemSchema `json:"offer,omitempty"`
	Passengers []FlightBookingCustomerSchema `json:"passengers,omitempty"`

...
class CompaniesApi
{
     ...
     * @param  int $limit Maximum number of companies (optional)
     ...
     */
    public function companiesGet($sort = null, $limit = null, $page = '1')
    {
        list($response) = $this->companiesGetWithHttpInfo($sort, $limit, $page);
        return $response;
    }
     ...
     */
    public function companiesGetWithHttpInfo($sort = null, $limit = null, $page = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->companiesGetRequest($sort, $limit, $page);
     ...
     */
    public function companiesGetAsync($sort = null, $limit = null, $page = '1')
    {
        return $this->companiesGetAsyncWithHttpInfo($sort, $limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesGetAsyncWithHttpInfo($sort = null, $limit = null, $page = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->companiesGetRequest($sort, $limit, $page);
     ...
     */
    protected function companiesGetRequest($sort = null, $limit = null, $page = '1')
    {
     ...
     * Update company
     *
     * @param  \Swagger\Client\Model\CompaniesIdBody $body body (required)
     * @param  string $id Company id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Company
     */
    public function companiesIdPatch($body, $id)
    {
        list($response) = $this->companiesIdPatchWithHttpInfo($body, $id);
        return $response;
    }
     ...
     * Update company
     *
     * @param  \Swagger\Client\Model\CompaniesIdBody $body (required)
     * @param  string $id Company id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Company, HTTP status code, HTTP response headers (array of strings)
     */
    public function companiesIdPatchWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Company';
        $request = $this->companiesIdPatchRequest($body, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesIdPatchAsync($body, $id)
    {
        return $this->companiesIdPatchAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesIdPatchAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Company';
        $request = $this->companiesIdPatchRequest($body, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function companiesIdPatchRequest($body, $id)
    {
     ...
     * Create company
     *
     * @param  \Swagger\Client\Model\CompaniesBody $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Company
     ...
     * Create company
     *
     * @param  \Swagger\Client\Model\CompaniesBody $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Company, HTTP status code, HTTP response headers (array of strings)

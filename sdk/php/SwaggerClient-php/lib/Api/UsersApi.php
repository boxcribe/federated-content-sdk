...
class UsersApi
{
     ...
     * @param  int $limit Maximum number of admins (optional)
     ...
     */
    public function usersGet($sort = null, $limit = null, $page = '1')
    {
        list($response) = $this->usersGetWithHttpInfo($sort, $limit, $page);
        return $response;
    }
     ...
     */
    public function usersGetWithHttpInfo($sort = null, $limit = null, $page = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20013';
        $request = $this->usersGetRequest($sort, $limit, $page);
     ...
     */
    public function usersGetAsync($sort = null, $limit = null, $page = '1')
    {
        return $this->usersGetAsyncWithHttpInfo($sort, $limit, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersGetAsyncWithHttpInfo($sort = null, $limit = null, $page = '1')
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20013';
        $request = $this->usersGetRequest($sort, $limit, $page);
     ...
     */
    protected function usersGetRequest($sort = null, $limit = null, $page = '1')
    {
     ...
     * Create User
     *
     * @param  \Swagger\Client\Model\UsersBody $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create User
     *
     * @param  \Swagger\Client\Model\UsersBody $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $this->usersuserIdDeleteWithHttpInfo();
    }
    ...
    {
        $returnType = '';
        $request = $this->usersuserIdDeleteRequest();
    ...
    {
        return $this->usersuserIdDeleteAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersuserIdDeleteRequest()
    {
     ...
     * @return \Swagger\Client\Model\InlineResponse201
     */
    public function usersuserIdGet($id)
    {
        list($response) = $this->usersuserIdGetWithHttpInfo($id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersuserIdGetWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->usersuserIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersuserIdGetAsync($id)
    {
        return $this->usersuserIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersuserIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->usersuserIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersuserIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling usersuserIdGet'
            );
        }
     ...
     * Update User
     *
     * @param  \Swagger\Client\Model\UsersUserIdBody $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse201
     */
    public function usersuserIdPatch($body)
    {
        list($response) = $this->usersuserIdPatchWithHttpInfo($body);
        return $response;
    }
     ...
     * Update User
     *
     * @param  \Swagger\Client\Model\UsersUserIdBody $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersuserIdPatchWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->usersuserIdPatchRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersuserIdPatchAsync($body)
    {
        return $this->usersuserIdPatchAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersuserIdPatchAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->usersuserIdPatchRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersuserIdPatchRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling usersuserIdPatch'
            );
        }

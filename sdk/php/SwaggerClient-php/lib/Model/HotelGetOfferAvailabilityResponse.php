...
/**
 * HotelGetOfferAvailabilityResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HotelGetOfferAvailabilityResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HotelGetOfferAvailabilityResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'hotel_images' => 'string[]',
        'hotel_rating' => 'float',
        'hotel_reviews' => 'map[string,object]',
        'hotel_stars' => 'int',
     ...
     *
     * @param map[string,object] $offer_cancelation_policies Details of the cancellation policies applicable to the offer.
     *
     * @return $this
     */
     ...
     * Sets hotel_reviews
     *
     * @param map[string,object] $hotel_reviews Collection of reviews for the hotel.
     *
     * @return $this
     */

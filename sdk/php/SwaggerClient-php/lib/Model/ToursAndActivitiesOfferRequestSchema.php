...
/**
 * ToursAndActivitiesOfferRequestSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ToursAndActivitiesOfferRequestSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ToursAndActivitiesOfferRequestSchema';
     ...
     *
     * @param float $location_latitude Latitude for the location.
     *
     * @return $this
     */
     ...
     *
     * @param float $location_longitude Longitude for the location.
     *
     * @return $this
     */
     ...
     *
     * @param float $location_radius Radius to search for tours and activities from the specified location.
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Starting date for tours and activities.
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date Ending date for tours and activities.
     *
     * @return $this
     */
     ...
     * Sets adults
     *
     * @param int $adults Number of adults participating.
     *
     * @return $this
     */
     ...
     * Sets children
     *
     * @param int $children Number of children participating.
     *
     * @return $this
     */
     ...
     *
     * @param string $filter_by_keyword Keyword to filter tours and activities.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $filter_by_subcategories Subcategories to filter tours and activities.
     *
     * @return $this
     */
     ...
     * Sets sort_by
     *
     * @param string $sort_by Criteria to sort the search results.
     *
     * @return $this
     */
     ...
     * Sets sort_order
     *
     * @param string $sort_order Order to sort the results (ascending or descending).
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language Language of the tour offers.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency Currency in which prices are displayed.
     *
     * @return $this
     */
     ...
     * Sets metric
     *
     * @param string $metric Unit for distance measurement (mi/km) used in filters.
     *
     * @return $this
     */

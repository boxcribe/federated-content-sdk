...
/**
 * BookingPassengerSelectedSeatSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BookingPassengerSelectedSeatSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BookingPassengerSelectedSeatSchema';
     ...
     * Sets passenger_id
     *
     * @param string $passenger_id Identifier of the passenger selecting a seat.
     *
     * @return $this
     */
     ...
     * Sets leg_id
     *
     * @param string $leg_id Identifier of the flight leg associated with the seat selection.
     *
     * @return $this
     */
     ...
     * Sets segment_id
     *
     * @param string $segment_id Identifier of the flight segment for the seat selection.
     *
     * @return $this
     */
     ...
     * Sets seat_number
     *
     * @param string $seat_number Seat number selected by the passenger.
     *
     * @return $this
     */
